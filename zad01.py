...
firstusernumber = int(input('Введите первое число: ')) # Строка ввода первого числа с текстом для пользователя
secondusernumber = int(input('Введите второе число: ')) # Строка ввода второго числа с текстом для пользователя
